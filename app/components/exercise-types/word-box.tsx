...
export default function WordBox({
  ...
  const wordOptions = useMemo(() => {
    return showKana ? question.options_kana : question.options;
  }, [question, showKana]);
                  ...
                  <Fragment key={index}>
                    ...
                    {index < expectedInputs && (
                      <TranscriptionPopup
                        ...
                        onOpenChange={(open) =>
                          handlePopupOpenChange(open, index)
                        }
                        HiraganaText={
                        ...
                        trigger={
                          <Input
                            ...
                            onChange={(e) =>
                              handleDirectInput(e.target.value, index)
                            }
                        ...
                        ${getInputClasses(index)}`}
                            disabled={
                              isPartSubmitted &&
                              resultsArrayFromInput[index] === true
                            }
                            autoComplete="off"
                            autoCorrect="off"
                            spellCheck="false"
